...
Dan selected **usesnaglist.com** as the customer-facing domain. The Snaglist brand stays unchanged. **Google Workspace Business Starter Flexible** for one staff mailbox is now approved at £7/month before tax; checkout is complete and Gmail is activated; all three aliases have passed inbound and outgoing reply/authentication checks. Website and staging domain wiring are applied, as detailed above; production API/portal cutover remains separate work.
...
At that historical registration checkpoint, no second domain, registrar upsell or email subscription had been bought. The later approved Workspace checkout and activation are recorded at the top of this document and supersede the then-pending mailbox decision.
